...
class ManageSchedule extends Component {
  ...
  componentDidUpdate(prevProps, prevState, snapshot) {
    ...
    if (prevProps.scheduleTimeRedux !== this.props.scheduleTimeRedux) {
      let data;
      if (
        this.props.scheduleTimeRedux &&
        this.props.scheduleTimeRedux.length > 0
      ) {
        data = this.props.scheduleTimeRedux.map((item) => ({
          ...item,
          isSelected: false,
        }));
      }
    ...
    return (
      <React.Fragment>
        <div className="manage-schedule-container">
          <div className="title mb-3">ManageDoctor Schedule</div>
          <div className="container">
            <div className="row">
              ...
              <div className="col-12 manage-schedule">
                {this.state.rangeScheduleTime &&
                  this.state.rangeScheduleTime.length > 0 &&
